    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                FLS(`[gotoBlock]: Двигаемся...едем к ${targetBlock}`);
        ...
        if (menuLinks.length > 0) {
            ...
            function menuLinkOnClick(e) {
                ...
                if (menuLink.dataset.goto && document.querySelector(menuLink.dataset.goto)) {
                    const linkBlock = document.querySelector(menuLink.dataset.goto);
                    const linkBlockValue = linkBlock.getBoundingClientRect().top + scrollY - document.querySelector("header").offsetHeight;
                    if (iconMenu.classList.contains("icon-menu")) {
                        document.documentElement.classList.remove("menu-open");
                        document.documentElement.classList.remove("lock");
                    }
                    window.scrollTo({
